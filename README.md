...
| [![NuGet](https://img.shields.io/nuget/v/Baubit.Mediation.svg)](https://www.nuget.org/packages/Baubit.Mediation/)<br/>[**Baubit.Mediation**](https://github.com/pnagoorkar/Baubit.Mediation) | Mediator pattern with cache-backed routing. 3-4x faster than MediatR |
